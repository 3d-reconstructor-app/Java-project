...
public class tabPhoto2 extends Fragment {
    ...
    private void requestPermissions() {
        if (checkPermission()) {
            ...
            Toast.makeText(context.getApplicationContext(), "Permissions granted..", Toast.LENGTH_SHORT).show();
            getImagePath();
        } else {
    ...
    private void requestPermission() {
        ...
        ActivityCompat.requestPermissions(getParentFragment().getActivity(), new String[]{READ_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
    }
    ...
    private void prepareRecyclerView() {
        ...
        imageRVAdapter = new RecyclerViewAdapter(getParentFragment().getActivity(), imagePaths);

        // on below line we are creating a new grid layout manager.
        GridLayoutManager manager = new GridLayoutManager(getParentFragment().getActivity(), 4);
            ...
            case PERMISSION_REQUEST_CODE:
                ...
                if (grantResults.length > 0) {
                    ...
                    if (storageAccepted) {
                        ...
                        Toast.makeText(getContext().getApplicationContext(), "Permissions Granted..", Toast.LENGTH_SHORT).show();
                        getImagePath();
                    } else {
                        // if permissions are denied we are closing the app and displaying the toast message.
                        Toast.makeText(getContext().getApplicationContext(), "Permissions denined, Permissions are required to use the app..", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
        }
