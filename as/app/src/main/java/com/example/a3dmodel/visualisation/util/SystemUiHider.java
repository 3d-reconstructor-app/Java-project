package com.example.a3dmodel.visualisation.util;
 ...
 * {@link #getInstance} will return a {@link com.example.a3dmodel.visualisation.util.SystemUiHiderHoneycomb} instance,
...
public abstract class SystemUiHider {
   ...
   * {@link SystemUiHiderBase} or {@link com.example.a3dmodel.visualisation.util.SystemUiHiderHoneycomb} depending on
   * the device.
   *
  ...
  public static SystemUiHider getInstance(Activity activity, View anchorView, int flags) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
      return new com.example.a3dmodel.visualisation.util.SystemUiHiderHoneycomb(activity, anchorView, flags);
    } else {
